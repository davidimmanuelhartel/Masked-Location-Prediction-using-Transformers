...
This script contains classes and functions to implement a transformer-based neural network. 

It is used to predict location labels based on a sequence of tokens, a mask indicating positions to predict, and user identifiers.

The architecture is based on the transformer model proposed by Vaswani et al. (2017) and is implemented using PyTorch.

The code is based on this tutorial: https://towardsdatascience.com/a-detailed-guide-to-pytorchs-nn-transformer-module-c80afbc9ffb1.
"""
